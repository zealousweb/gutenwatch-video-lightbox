	...
	return (
        ...
        <div {...useBlockProps.save()}>
            ...
            {attributes.selection === 'button' && ((isValidHttpUrl(attributes.videoUrl) || attributes.video) && (videoType === 'videourl' || videoType === 'uploadvideo')) ? (
                <>
                    <a data-fancybox={`video-lightbox-${blockClass}`} data-fancy-class={blockClass} href={attributes.videoUrl || attributes.video} className={`vl-button vl-icon-text-button ${blockClass}`}>
                ...
                attributes.selection === 'media' && selectedSize && image && ((isValidHttpUrl(attributes.videoUrl) || attributes.video) && (videoType === 'videourl' || videoType === 'uploadvideo')) && (
                        <a data-fancybox={`video-lightbox-${blockClass}`} data-fancy-class={blockClass} href={attributes.videoUrl || attributes.video} class={`video-thumbnail ${blockClass}`} >
