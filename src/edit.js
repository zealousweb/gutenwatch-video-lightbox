...
import { MediaUploadCheck, MediaUpload, InspectorControls, PanelColorSettings, ColorPalette } from '@wordpress/block-editor';
import { Button, TextControl, RadioControl, Panel, PanelBody, SelectControl, ToggleControl, RangeControl } from '@wordpress/components';
    ...
    return (
        <div className={`zwt-vlfgb ${blockClass}-main`}>
            ...
            <InspectorControls>
                ...
                <Panel className="zwt-vlfgb-panel">
                    ...
                    {attributes.selection === 'media' && (
                        <PanelBody title={__('Play Icon Settings', 'video-lightbox-for-guten-blocks')}>
                            <ToggleControl
                                label={__('Custom Play Icon', 'video-lightbox-for-guten-blocks')}
                                                ...
                                                render={({ open }) => (
                                                    <div>
                                                        <Button
                                                            ...
                                                            <svg viewBox="0 0 24 24" fill="transparent" width="24"><g> <rect x="0" fill="none"></rect> <g> <path d="M23 4v2h-3v3h-2V6h-3V4h3V1h2v3h3zm-8.5 7c.828 0 1.5-.672 1.5-1.5S15.328 8 14.5 8 13 8.672 13 9.5s.672 1.5 1.5 1.5zm3.5 3.234l-.513-.57c-.794-.885-2.18-.885-2.976 0l-.655.73L9 9l-3 3.333V6h7V4H6c-1.105 0-2 .895-2 2v12c0 1.105.895 2 2 2h12c1.105 0 2-.895 2-2v-7h-2v3.234z"></path> </g> </g></svg>
                    ...
                    <PanelColorSettings
                        ...
                        colorSettings={[
                            {
                                value: attributes.videoLightboxColor,
                                onChange: handleLightBoxOverlayColorChange,
                                        ...
                                        {attributes.image ? (
                                            <div className={`video-thumbnail ${blockClass}`}>
                                                ...
                                                {attributes.playIconEnabled && attributes.playIconImage ? (
                                                    ...
                                                    <svg viewBox="0 0 24 24" fill="transparent" width={attributes.playIconImageSize} className="play-icon"><g><path fill-rule="evenodd" clip-rule="evenodd" d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22ZM10.6935 15.8458L15.4137 13.059C16.1954 12.5974 16.1954 11.4026 15.4137 10.941L10.6935 8.15419C9.93371 7.70561 9 8.28947 9 9.21316V14.7868C9 15.7105 9.93371 16.2944 10.6935 15.8458Z" fill="currentColor" ></path> </g></svg>
                                                )}
                                                <Button className={`vl-button vl-icon-button`} onClick={removeImage}>
                                                    <svg viewBox="0 0 24 24" fill="transparent" width="24"><g><path d="M13 4H8.8C7.11984 4 6.27976 4 5.63803 4.32698C5.07354 4.6146 4.6146 5.07354 4.32698 5.63803C4 6.27976 4 7.11984 4 8.8V15.2C4 16.8802 4 17.7202 4.32698 18.362C4.6146 18.9265 5.07354 19.3854 5.63803 19.673C6.27976 20 7.11984 20 8.8 20H15.2C16.8802 20 17.7202 20 18.362 19.673C18.9265 19.3854 19.3854 18.9265 19.673 18.362C20 17.7202 20 16.8802 20 15.2V11" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M4 16L8.29289 11.7071C8.68342 11.3166 9.31658 11.3166 9.70711 11.7071L13 15M13 15L15.7929 12.2071C16.1834 11.8166 16.8166 11.8166 17.2071 12.2071L20 15M13 15L15.25 17.25" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M17 3L19 5M21 7L19 5M19 5L21 3M19 5L17 7" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                                            ...
                                            <Button className={`vl-button vl-icon-text-button`} onClick={open}>
                                                <svg viewBox="0 0 24 24" width="24" height="24" fill="transparent" ><g> <rect x="0" fill="transparent"></rect> <g> <path d="M23 4v2h-3v3h-2V6h-3V4h3V1h2v3h3zm-8.5 7c.828 0 1.5-.672 1.5-1.5S15.328 8 14.5 8 13 8.672 13 9.5s.672 1.5 1.5 1.5zm3.5 3.234l-.513-.57c-.794-.885-2.18-.885-2.976 0l-.655.73L9 9l-3 3.333V6h7V4H6c-1.105 0-2 .895-2 2v12c0 1.105.895 2 2 2h12c1.105 0 2-.895 2-2v-7h-2v3.234z"></path> </g> </g></svg>
