                                ...
                                <div>
                                    {attributes.playIconImage ? (
                                        <div class="vl-thumbnail">
                                            ...
                                            <Button className={`vl-button vl-icon-button ${blockClass}`} onClick={removeIcon}>
                            ...
                            <>
                                {attributes.video ? (
                                    ...
                                    <div className="video-thumbnail ">
                                        ...
                                        <Button className={`vl-button vl-icon-button ${blockClass}`} onClick={removeVideo}>
                                    ...
                                    <>
                                        {attributes.image ? (
                                            <div className={`video-thumbnail ${blockClass}`}> 
                                                ...
                                                <Button className={`vl-button vl-icon-button ${blockClass}`} onClick={removeImage}>
